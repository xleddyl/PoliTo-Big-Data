...
/**
* Compute the list of potential friends of each user
* @input: textual file containing pairs of users (friends)
* @output: textual file with one user per line alongside with their potential friends list
*/
